...
from vallejo_scraper.models import MRPResult, Verdict
...
STATIC_DIR = Path(__file__).parent / "src" / "vallejo_scraper" / "static"
...
async def run_pipeline():
    ...
    for listing in listings:
        ...
        verdict = classify(ask_price=listing.list_price, mrp=mrp_result.mrp, rent_source=listing.rent_source)
        results.append({
